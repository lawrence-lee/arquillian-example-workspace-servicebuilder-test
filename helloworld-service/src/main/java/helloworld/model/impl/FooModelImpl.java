...
import helloworld.model.FooModel;
import helloworld.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(helloworld.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.helloworld.model.Foo"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(helloworld.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.helloworld.model.Foo"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(helloworld.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.helloworld.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(helloworld.service.util.ServiceProps.get(
				"lock.expiration.time.helloworld.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("helloworld.model.Foo");
