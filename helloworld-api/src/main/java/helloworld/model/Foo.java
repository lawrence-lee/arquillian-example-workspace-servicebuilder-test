 ...
 * @see FooModel
 * @see helloworld.model.impl.FooImpl
 * @see helloworld.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("helloworld.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link helloworld.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
