...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<helloworld.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public helloworld.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public helloworld.model.Foo toUnescapedModel() {
		return new FooWrapper(_foo.toUnescapedModel());
	}

	@Override
	public int compareTo(helloworld.model.Foo foo) {
